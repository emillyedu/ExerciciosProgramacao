...
*
* Observações: a função Media não estava calculando corretamente
* pois ela era uma função inteira, a qual só imprime valores 
* inteiros e ignora os números após a vírgula. Para corrigir isso,
* o int foi substituido por float, tornando a função flutuante e
* permitindo que ela imprima o valor corretamente, informando os 
